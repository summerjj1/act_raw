...
# Sony raw_5: 15 evenly spaced test episodes (10,20,...,150), 135-episode train pool.
...
TASK_NAME="${TASK_NAME:-pick_place_sony_raw5_sp1_sp2_linear_quat_train135_test15_every10_step${TARGET_STEPS}}"
